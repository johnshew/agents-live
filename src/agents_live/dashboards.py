...
# Dual-layout import, as in dashboard.py: packaged, the sibling modules
# belong to the agents_live package and must be imported through it so
# their relative imports resolve; flat, they are top-level scripts
# beside this file. __init__.py is the layout discriminator.
if (SCRIPTS_DIR / "__init__.py").is_file():
    if str(SCRIPTS_DIR.parent) not in sys.path:
        sys.path.insert(0, str(SCRIPTS_DIR.parent))
    from agents_live import hostruntime, paths  # noqa: E402
else:
